...
class XLNetData:
    ...
    def _get_inputs(self):
        ...
        inps = [self.tokenizer.encode_plus(t, max_length=self.sequence_len, pad_to_max_length=True, add_special_tokens=True, truncation=True) for t in
                x]
    ...
    # Get weights based on distribution of classes
